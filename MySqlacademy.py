...
class MySqlHandlerAcademy:
    ...
    def Insert(self,TableName,How_I_feel,How_I_Sleep,Do_I_Feel_depressed,Do_I_Feel_anxiety,
        Do_I_Feel_Fear,Have_appetite,myscore,_Date,_User_ID):
        ...
        Date=_Date,
        Score=myscore,
        Mental_state= How_I_feel,
        Anxiety_level=Do_I_Feel_anxiety,
        Fear_level=Do_I_Feel_Fear,
        Depression_level=Do_I_Feel_depressed,
        Sleeping_status=How_I_Sleep,
        Appetite_level = Have_appetite
